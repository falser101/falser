import{_ as i,r as d,o as l,c as r,a as e,b as n,d as c,e as s}from"./app-a50c9339.js";const t={},v=s('<h2 id="第一步" tabindex="-1"><a class="header-anchor" href="#第一步" aria-hidden="true">#</a> 第一步</h2><p>首先自己购买一个服务器</p><h2 id="第二步" tabindex="-1"><a class="header-anchor" href="#第二步" aria-hidden="true">#</a> 第二步</h2><p>购买一个域名挂载到服务器，各个域名服务商有详细的文档这里就不再写了</p><h2 id="第三步" tabindex="-1"><a class="header-anchor" href="#第三步" aria-hidden="true">#</a> 第三步</h2>',5),u=e("img",{src:"https://kuangstudy.oss-cn-beijing.aliyuncs.com/bbs/2021/03/28/kuangstudy6d0a31df-a8f5-467b-b518-24ac70e870f2.png",alt:""},null,-1),o={href:"https://cloud.tencent.com/document/product/400/4142#ManualVerification",target:"_blank",rel:"noopener noreferrer"},m=s(`<h1 id="编写default-conf" tabindex="-1"><a class="header-anchor" href="#编写default-conf" aria-hidden="true">#</a> 编写default.conf</h1><p>下面是我自己的证书和域名</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>server {
    #SSL 访问端口号为 443
    listen 443 ssl;
    #填写绑定证书的域名
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>启动成功 <img src="https://kuangstudy.oss-cn-beijing.aliyuncs.com/bbs/2021/03/28/kuangstudy610b21ad-2256-4b1c-b387-a47eb35df8e5.png" alt="启动成功"></p>`,9);function b(p,h){const a=d("ExternalLinkIcon");return l(),r("div",null,[v,e("p",null,[n("申请ssl证书并且将证书和需要部署的静态页面上传到服务器如下图 "),u,e("a",o,[n("腾讯SSL证书域名验证指引"),c(a)])]),m])}const _=i(t,[["render",b],["__file","02.nginx peizhihttpsfangwenyunfuwuqi.html.vue"]]);export{_ as default};
