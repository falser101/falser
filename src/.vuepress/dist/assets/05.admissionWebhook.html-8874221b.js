...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查看busybox-2的yaml并没有对应的volume</p>`,24);function m(k,b){const a=l("ExternalLinkIcon");return o(),p("div",null,[s("p",null,[s("a",r,[n("原文链接"),e(a)])]),d,s("p",null,[n("代码来自"),s("a",u,[n("Github仓库"),e(a)])]),v])}const f=t(c,[["render",m],["__file","05.admissionWebhook.html.vue"]]);export{f as default};
