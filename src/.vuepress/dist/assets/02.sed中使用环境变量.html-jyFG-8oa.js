import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,f as t}from"./app-HmUwe2V9.js";const d={},i=t(`<blockquote><p>如何在Sed命令中使用环境变量 https://cn.linux-console.net/?p=15424</p></blockquote><p>有一个test.conf文件内容如下</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>key=value
